...
Convert Chinese number expressions to Arabic numerals
through regular expression matching and replacement.
...
# ============================================================
# Part 1: configuration and mappings.
# ============================================================

# Map Chinese unit names; None preserves the original unit.
unit_mapping = {
...
# ============================================================
# Part 2: range expressions.
# ============================================================

def _chinese_digit_to_num(char):
    """Convert one Chinese digit to an Arabic digit."""
    return value_mapper.get(char, 0)

def _parse_tens(tens):
    """Parse a standalone tens unit or a digit followed by tens."""
...
def _convert_range_pattern_1(match):
    """Convert adjacent-digit ranges with magnitude suffixes, such as 300~500."""
    groups = match.groups()
...
def _convert_range_pattern_2(match):
    """Convert ranges with a shared base, such as 15~16 or 160~170."""
    groups = match.groups()
...
def _convert_range_pattern_3(match):
    """Convert an adjacent-digit range, such as 3~4 or 5~6."""
    d1, d2 = match.groups()
    v1 = _chinese_digit_to_num(d1)
    v2 = _chinese_digit_to_num(d2)
    return f"{v1}~{v2}"
...
def convert_range_expression(text):
    ...
    # Reuse strip_unit to remove the physical-unit suffix.
    stripped_text = text
    mapped_unit = ''
...
# ============================================================
# Part 3: regular expression patterns.
# ============================================================
...
def strip_trailing_unit(text):
    """Strip trailing units with a regular expression."""
...
def convert_value_num(original):
    """Convert a Chinese numeric value to Arabic numerals."""
    stripped, unit = strip_unit(original)
...
# ============================================================
# Part 6: replacement pipeline.
# ============================================================

def replace(original):
    """Replace one matched expression."""
